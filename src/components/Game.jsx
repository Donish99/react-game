...
class Game extends Component{
    ...
    componentDidUpdate(previous) {
        if(this.props.gameSpeed !== "default" && this.props.gameSpeed !== this.state.snakeSpeed){
            this.setState({snakeSpeed: this.props.gameSpeed})
        } else if(this.props.gameSpeed === 'default' && this.state.snakeSpeed !== 200 && previous.gameSpeed !== 'default'){
